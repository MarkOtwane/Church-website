...
<!-- End Site Header --> 
  ...
  <div class="hero-slider flexslider clearfix" data-autoplay="yes" data-pagination="yes" data-arrows="yes" data-style="fade" data-pause="yes">
    <ul class="slides">
      <li class=" parallax" style="background-image:url(images/slide101.jpg);"></li>
      <li class="parallax" style="background-image:url(images/slide102.jpg);"></li>
      <li class="parallax" style="background-image:url(images/slide111.jpg);"></li>
    </ul>
  </div>
  <!-- End Hero Slider --> 
  <!-- Start Notice Bar -->
          ...
          <div class="col-md-8 col-sm-6"> 
            ...
            <div class="listing events-listing">
              <header class="listing-header">
                <h3 class=" titles">Welcome to Deliverence  Church Ndagani</h3>
              </header>
			  <?php
              ...
              <section class="listing-cont">
                <ul>
                  <li class="item sermon featured-sermon"> <span class="date"></span>
                    <h4><a href="https://www.facebook.com/profile.php?id=100095113817394&mibextid=ZbWKwL">Like Us on Facebook</a></h4>
					<?php
                            //include('../connect.php');
               ...
               ?> 
                    <div class="featured-sermon-video">
                      <!--Facebook Page-->
<iframe src="https://www.facebook.com/profile.php?id=100095113817394&mibextid=ZbWKwL<?php echo $row['facebook'];?>%2F&tabs=timeline&width=20025&height=215&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=403202216515066" 
        width="100%" height="214" style="border:none;overflow:hidden" scrolling="no" frameborder="0" 
                  ...
                  <li class="item post">
                    <div class="row">
                      <div class="col-md-12"> <a href="donate.php" class="media-box"> <img src="images/giving101.png" alt="" class="img-thumbnail"> </a></div>
                     </div>
                  </li>
				   <li class="item post">
                    <div class="row">
